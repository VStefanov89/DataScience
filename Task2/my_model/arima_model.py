...
"""
We will be using Augmented Dickey-Fuller (ADF) test to check is our data stationary. The Null hypothesis of this test
...
plot below shows us that partial autocorrelation is going extremly fast in negative territory, which  indicating the 
...
is goint too fast in negative territory, so again we can conclude that the data is stationary and our 'q' value is 
equal to 0
"""
...
"""
Our model is showing that the p values are 0, so our coefficients we could say are significant
"""
